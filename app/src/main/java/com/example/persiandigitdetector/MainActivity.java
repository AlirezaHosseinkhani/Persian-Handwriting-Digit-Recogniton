...
public class MainActivity extends AppCompatActivity {
    ...
    private void renderResult(Result result) {
        mTvPrediction.setText(FaNum.convert(String.valueOf(result.getNumber())));
        mTvProbability.setText("%"+FaNum.convert(String.valueOf(Math.round(result.getProbability()*100.0))));
        mTvTimeCost.setText(FaNum.convert(String.format(getString(R.string.timecost_value),
                result.getTimeCost())));
    }
}